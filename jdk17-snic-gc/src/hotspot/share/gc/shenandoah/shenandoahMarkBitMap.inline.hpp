...
inline bool ShenandoahMarkBitMap::mark_strong(HeapWord* heap_addr, bool& was_upgraded) {
  ...
  // std::cout << "DGC LOG: input addr " << heap_addr << std::endl;
  // std::cout << "DGC LOG: bit " << bit << std::endl;
  // std::cout << "DGC LOG: load address " << (void*)addr << std::endl;
  // std::cout << "DGC LOG: load content " << *((int*)addr) << std::endl;
