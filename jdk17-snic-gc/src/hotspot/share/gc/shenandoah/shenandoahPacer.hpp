...
public:
  /*start @lyh*/
  volatile double _predicted_alloc_rate; // words/ms
  /*end @lyh*/
...
public:
  ...
  void setup_for_idle();
  void setup_for_global_pacer();
  size_t compute_predicted_alloc_rate();
  void setup_for_mark();
  void setup_for_evac();
  void setup_for_updaterefs();
  void setup_for_global_pacer_Client_Occupied();
  ...
  inline void report_global_pacer_mark(size_t words);
