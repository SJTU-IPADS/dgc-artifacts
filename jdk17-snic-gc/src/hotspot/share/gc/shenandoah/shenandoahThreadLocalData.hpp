...
private:
  ...
  int  _disarmed_value;
  double _paced_time;
  double _paced_mark_time;
  double _paced_evac_time;
  double _paced_update_time;
  double _paced_idle_time;
...
public:
  ...
  static void add_paced_mark_time(Thread* thread, double v) {
    data(thread)->_paced_mark_time += v;
  }

  static double paced_mark_time(Thread* thread) {
    return data(thread)->_paced_mark_time;
  }

  static void reset_paced_mark_time(Thread* thread) {
    data(thread)->_paced_mark_time = 0;
  }

  static void add_paced_evac_time(Thread* thread, double v) {
    data(thread)->_paced_evac_time += v;
  }

  static double paced_evac_time(Thread* thread) {
    return data(thread)->_paced_evac_time;
  }

  static void reset_paced_evac_time(Thread* thread) {
    data(thread)->_paced_evac_time = 0;
  }

  static void add_paced_idle_time(Thread* thread, double v) {
    data(thread)->_paced_idle_time += v;
  }

  static double paced_idle_time(Thread* thread) {
    return data(thread)->_paced_idle_time;
  }

  static void reset_paced_idle_time(Thread* thread) {
    data(thread)->_paced_idle_time = 0;
  }

  static void add_paced_update_time(Thread* thread, double v) {
    data(thread)->_paced_update_time += v;
  }

  static double paced_update_time(Thread* thread) {
    return data(thread)->_paced_update_time;
  }

  static void reset_paced_update_time(Thread* thread) {
    data(thread)->_paced_update_time = 0;
  }
