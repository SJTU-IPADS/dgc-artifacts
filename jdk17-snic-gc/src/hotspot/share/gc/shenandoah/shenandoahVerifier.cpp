...
private:
  ...
  void do_oop_work(T* p) {
    ...
    if (!CompressedOops::is_null(o)) {
      ...
      //log_dev_trace(gc)("DGC LOG: verify at p=%p, o=%p, end of o=%p", p, obj, (unsigned long long)obj + obj->size() * wordSize);
      if (is_instance_ref_klass(obj->klass())) {
        obj = ShenandoahForwarding::get_forwardee(obj);
        //log_dev_trace(gc)("DGC LOG: instance_ref, get_forwardee=%p", obj);
      }
