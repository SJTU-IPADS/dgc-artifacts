...
class ReservedSpace {
 ...
 public:
  ...
  // Added by LHT for SNIC GC
  void commit_memory_and_reg_rdma();
  /*start @lyh*/
  void remap_reserved_space_with_backup(const char* backup_file_path, int fd);
  /*end @lyh*/
};
