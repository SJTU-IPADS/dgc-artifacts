#!/bin/bash
# table3-dgc-rdma-specjbb-hbase-mix-run.sh
# DGC-RDMA SPECjbb+HBase mix workload for Table 3 reproduction.
...
HBASE_BASE_PATH="$HOME_DIR/hbase-test/rdma-multi-regionserver-hbase"
...
CDS_OPTION="-Xshare:on -XX:SharedArchiveFile=$CDS_JSA"
SNIC_GC_OPTION="$CDS_OPTION -XX:SNICAddr=$NODE_IP -XX:HostAddr=$NODE_IP -XX:HeapBaseMinAddress=0x500000000 -XX:+UnlockExperimentalVMOptions -XX:+UnlockDiagnosticVMOptions -XX:-ShenandoahVerify -XX:-SnicGCShareMemEnabled"
    ...
    do
        ...
        do
            ...
            do
                ...
                COOR_RDMA_PORT=9999
                RDMA_PORT=2340
                log_path="$LOG_PATH/$heap_config_name/${CCMT_THREAD}/${CCET_THREAD}/${PCORE}/${GROUP_NUM}/rdma"
                function run_coordinator {
                    ...
                    GC_OPTION="-XX:+SnicGCCoorHeuristic -XX:SnicGCCoorSHMPath=/${USER}_coor_heuristic -XX:SnicGCCoorClientNum=4 -XX:+SnicGCCoordinator -XX:+SnicCoorAdaptiveCCMT -XX:SnicAvgMarkTimeAmplifyRate=2.0 -XX:SnicShmGlobalPacerPath=/${USER}_share_global_pacer -XX:ParallelGCThreads=${COOR_CCMT_THREAD} -XX:ConcGCThreads=${COOR_CCMT_THREAD} -XX:SnicCoorFrozenDGCUpperBound=80 -XX:SnicCoorHostAddrPortList=\"$NODE_IP:9999;$NODE_IP:10000;$NODE_IP:10001;$NODE_IP:10002\""
